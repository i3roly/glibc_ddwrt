...
TK_LIBS='-L/usr/X11R6/lib -lX11   -lpthread -ldl -lz  -lpthread -lm'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/Volumes/xtoolshit/misc/dd-wrt/src/router/tk8.6.9/unix -ltk8.6'
...
# compiled.
TK_SRC_DIR='/Volumes/xtoolshit/misc/dd-wrt/src/router/tk8.6.9'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/Volumes/xtoolshit/misc/dd-wrt/src/router/tk8.6.9/unix -ltkstub8.6'
...
TK_BUILD_STUB_LIB_PATH='/Volumes/xtoolshit/misc/dd-wrt/src/router/tk8.6.9/unix/libtkstub8.6.a'
